...
import ai.agora.publicapi.auth.Authentication;
import ai.agora.publicapi.auth.HttpBasicAuth;
import ai.agora.publicapi.auth.HttpBearerAuth;
import ai.agora.publicapi.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://core.agoraai.tech/api/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://core.agoraai.tech/api/v1",
      "Production API",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://core-dev.agoraai.tech/api/v1",
      "Development API",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://core.agoraai.tech/api/v1
     ...
     * @return a {@link ai.agora.publicapi.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.agora.publicapi.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.agora.publicapi.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.agora.publicapi.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.agora.publicapi.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.agora.publicapi.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.agora.publicapi.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.agora.publicapi.ApiException If fails to update the parameters
     */
    ...
    private void applySslSettings() {
        try {
            ...
            if (!verifyingSsl) {
                throw new IllegalStateException("Disabling SSL verification is not supported in this SDK.");
            } else {
     ...
     * @throws ai.agora.publicapi.ApiException If fail to serialize the request body object into a string
     */
